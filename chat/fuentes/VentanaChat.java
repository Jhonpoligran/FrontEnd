...
public class VentanaChat implements ActionListener {
    ...
    public TextArea areaDeTextoEnviado;
    ...
    public VentanaChat(int numPuertoServidor) {
        ...
        f = new Frame("JAVACHAT  v0.5    [IP local: " + dirIPLocal
        ...
        opcionMenuCerrarVentana = new MenuItem("Cerrar ESTA ventana");
        ...
        areaDeTextoEnviado = new TextArea(30, 30);
       // etiquetafecha =new Label (" dffd ");
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (objetoOrigenDelEvento == botonAceptar) {
            ...
            try {
                numPuertoRemoto = Integer.valueOf(campoPuerto.getText())
                        .intValue();
            ...
            if ((conexion != null) & (conexion.correcto)) {
                ...
                System.out
                        .println("Cliente: Conexion establecida correctamente");
            } else {
                System.out
                        .println("Cliente: Conexion fallida. Intentalo de nuevo");
            }
        }
    ...
    /**
     * @param ipRemoto IP del PC remoto
     * @param numPRemoto Numero de Puerto de Pc Remoto
     */
    public void conecta(String ipRemoto, int numPRemoto) {
        ...
        etiquetaEstado.setText("CONECTADO con IP " + ipRemoto + " [puerto "
                + numPRemoto + "]");
